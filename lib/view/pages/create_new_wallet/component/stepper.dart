            ...
            //     : 
                Text(
                    ...
                    style: AppFont.medium14.copyWith(
                        color: AppColor.white,
                        fontSize: (currentStep == 0) ? 24.sp : 16.sp),
                  ),
          ),
        ),
        Container(
          ...
          height: 3.w,
          color:
              (currentStep >= 1) ? AppColor.primaryColor : AppColor.darkerGray,
        ),
        Container(
          ...
          child: Center(
            ...
            //     : 
              ...
              style: AppFont.medium14.copyWith(
                  color: AppColor.white,
                  fontSize: (currentStep == 1) ? 24.sp : 16.sp),
            ),
          ),
        ),
        Container(
          ...
          height: 3.w,
          color:
              (currentStep >= 2) ? AppColor.primaryColor : AppColor.darkerGray,
        ),
        Container(
          ...
          child: Center(
            ...
            //     : 
              ...
              style: AppFont.medium14.copyWith(
                  color: AppColor.white,
                  fontSize: (currentStep == 2) ? 24.sp : 16.sp),
            ),
          ),
        ),
        // Container(
