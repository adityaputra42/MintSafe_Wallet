...
import 'package:mintsafe_wallet/domain/controller/security_privacy_controller.dart';
import 'package:mintsafe_wallet/utils/utils.dart';

import '../../../../config/config.dart';
import '../../../widget/widget.dart';

class AlertPasswordSecurity extends StatelessWidget {
  AlertPasswordSecurity({
    super.key,
    required this.title,
    this.subTitle,
    this.onTap,
