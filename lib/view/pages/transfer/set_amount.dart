...
import 'package:mintsafe_wallet/view/pages/transfer/confirm_taransfer.dart';
    ...
    return Obx(() {
      return Scaffold(
        ...
        bottomNavigationBar: PrimaryButton(
          title: "Continue",
          disable: controller.buttonInputAmount.value,
          onPressed: () {
            Get.to(() => ConfirmTransfer(assetType: assetType));
          },
